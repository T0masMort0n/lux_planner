...
### Risk: Premature Task Hierarchy Expansion

**Triggered By:** Future nesting feature
**Risk Description:** Introducing deep task hierarchy before flat task workflows are validated may distort Goals, Scheduler semantics, sharing logic, and system simplicity.

**Mitigation:**
Gate hierarchy behind post-dogfooding review
Require Systems Designer contract before implementation
Monitor performance + UX complexity