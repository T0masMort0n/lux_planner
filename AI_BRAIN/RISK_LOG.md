...
### Risk: Documentation Redundancy / Drift
**Date:** 2026-02-08  
**Triggered By Change:** Rapid contract expansion across multiple AI_BRAIN docs  
**Risk Description:** Duplicate/partial contract definitions across multiple files can create conflicting guidance (SSOT ambiguity) and reviewer loops.  
**Mitigations / Guardrails:**
- Treat LUX_SYSTEM_CONTRACTS.md as the single master for system interaction contracts.
- Keep PROJECT_RULES as a short “operational rules” index that points to master contracts.
- Quarterly/ milestone audits to compress + reconcile.  
**Signed:** Documentation Auditor
